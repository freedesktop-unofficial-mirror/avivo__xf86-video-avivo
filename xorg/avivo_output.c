...
avivo_output_tmds1_setup(xf86OutputPtr output)
{
    ...
    tmp = INREG(AVIVO_TMDSA_TRANSMITTER_CONTROL);
...
avivo_output_tmds2_setup(xf86OutputPtr output)
{
    ...
    tmp = INREG(AVIVO_LVTMA_TRANSMITTER_CONTROL);
    ...
    OUTREG(AVIVO_LVTMA_TRANSMITTER_CONTROL, tmp);
    OUTREG(AVIVO_LVTMA_TRANSMITTER_CONTROL, tmp | (AVIVO_LVTMA_TRANSMITTER_CONTROL_PLL_ENABLE | AVIVO_LVTMA_TRANSMITTER_CONTROL_PLL_RESET));
    OUTREG(AVIVO_LVTMA_TRANSMITTER_CONTROL, tmp);
...
avivo_output_tmds1_dpms(xf86OutputPtr output, int mode)
{
    ...
    case DPMSModeSuspend:
    case DPMSModeOff:
        OUTREG(AVIVO_TMDSA_TRANSMITTER_ENABLE, 0);
